...
const CommunityPostDetail: NextPage = () => {
  return (
    <Layout canGoBack title="질문내용 들어가?">
      <div className="pt-10">
        {/* 태그 */}
        ...
        {/* 질문자 프로필 */}
        <Link href="/profile">
          <a className="mb-3 flex cursor-pointer items-center space-x-3 border-b px-4 pb-3 transition hover:text-orange-500">
            <div className="h-8 w-8 rounded-full bg-slate-300" />
            <div>
              <p className="text-xs font-medium ">Steve Jebs</p>
            </div>
          </a>
        </Link>
        {/* 질문내용 */}
        <div>
          ...
          <div className="px-5 font-medium text-gray-700">
            ...
            <span className="font-medium">먹을거 추천점</span>
          </div>
          {/* 궁금해요, 답변란 */}
        ...
        <div className="my-5 space-y-5 px-5">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <Link href="/profile">
                <a className="block cursor-pointer text-sm font-medium text-gray-700 hover:text-orange-400">
                  Steve Jebs
                </a>
              </Link>
